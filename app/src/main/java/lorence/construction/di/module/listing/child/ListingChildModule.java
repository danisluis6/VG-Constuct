...
@Module
public class ListingChildModule {
    ...
    public ListingChildModule(Context context, HomeActivity homeActivity, ListingOperationFragment fragment, ListingOperationView listingOperationView) {
        mContext = context;
